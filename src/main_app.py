...
def parse_args():
    parser = argparse.ArgumentParser(description="Launch Gradio interface with various options.")
    parser.add_argument("--inbrowser", action="store_true", help="Launch the interface in the browser.")
    parser.add_argument("--share", action="store_true", help="Create a shareable link for the interface.")
